...
Multiplicando la proporción por 4, obtenemos la estimación actual de $\\pi$. ¡Cuantos más puntos sumes, más estable se volverá el decimal!
    ...
    with col_der:
        ...
        # Dibujamos el contorno exterior del cuadrado de simulación (rango -1 a 1)
        import matplotlib.patches as patches
        rect = patches.Rectangle((-1, -1), 2, 2, linewidth=2, edgecolor='black', facecolor='none')
        ax.add_patch(rect)
        
        # Dibujamos la línea de indicación de radio igual a 1
        ax.plot([0, 1], [0, 0], color='black', linestyle='--', linewidth=1.5)
        ax.text(0.4, 0.05, 'R=1', fontsize=12, color='black', fontweight='bold')
        # -------------------------------------
